        ...
        <div className="top-navbar-content">
          <div className="react-logo">
            <svg viewBox="0 0 24 24" width="20" height="20">
              <path
                fill="#ffffff"
                d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.276 0-.56.015-.854.05C7.367.952 9.17 2.322 12 2.322c2.83 0 4.633-1.37 5.747-1.946-.293-.035-.577-.05-.853-.05zM12 22.322c-2.83 0-4.633 1.37-5.747 1.946.293.035.577.05.853.05 1.346 0 3.107-.96 4.888-2.622 1.78 1.653 3.542 2.602 4.887 2.602.276 0 .56-.015.854-.05C16.633 23.048 14.83 22.322 12 22.322zm-4.888-2.622c-1.78-1.653-3.542-2.602-4.887-2.602-.276 0-.56.015-.854.05C7.367 23.048 9.17 22.322 12 22.322c2.83 0 4.633.726 5.747 1.37-.293.035-.577.05-.853.05-1.346 0-3.107-.96-4.888-2.622z"
              />
            </svg>
          </div>
          <TextType
